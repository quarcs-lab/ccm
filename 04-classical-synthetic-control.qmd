...
1. Construct the four-stage `tidysynth` pipeline that optimises donor weights $w_j$ on the unit simplex to match the treated unit's pre-period predictor profile. This is the workhorse of the single-treated-unit synthetic-control literature and recurs in chapters 5, 7, and 8.
