...
identifying assumptions, one substantive question. Chapter 11 then
...
Chapter 9's 2003-2007 working window leaves the 2004 cohort with
...
The outcome `lemp` (log teen employment; see chapter 9 for full
...
otherwise) line up with chapter 9's definitions.
...
compare `fect::mc` against the canonical reference code. Chapter 11
